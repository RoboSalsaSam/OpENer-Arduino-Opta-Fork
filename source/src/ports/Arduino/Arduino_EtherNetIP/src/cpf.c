 ...
 ******************************************************************************/
 ...
 //cpf.c was modified to move the large CipMessageRouterResponse buffer from stack storage to static storage, reducing stack usage on the Arduino Opta.
#include <string.h>
...
/* Keep large response buffers out of the small Arduino/Mbed thread stack. */
                                   ...
                                   ENIPMessage *const outgoing_message)
{
  ...
  CipMessageRouterResponse *message_router_response = &g_message_router_response; //Uses the new Arduino static buffer instead of creating the structure on the stack.
  InitializeMessageRouterResponse(message_router_response);
  if (kEipStatusError == (return_value =
                              CreateCommonPacketFormatStructure(received_data->current_communication_buffer_position,
    ...
    {                                /* ConnectedAddressItem item */
      ...
      if (NULL != connection_object)
      {
        ...
        { /* connected data item received*/
          ...
          CipMessageRouterResponse *message_router_response = &g_message_router_response;
          InitializeMessageRouterResponse(message_router_response);
