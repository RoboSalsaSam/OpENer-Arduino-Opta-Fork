 ...
 */
 ...
 //generic_networkhandler.h was modified for Arduino by replacing the POSIX/lwIP fd and timing types with the Opta/Mbed compatibility types.
...
extern opener_fd_set_t master_socket;
extern opener_fd_set_t read_socket;
...
extern opener_timeval_t g_time_value;
